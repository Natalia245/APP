...
var computer = makeImage("images/tumblr_o4i9ojQcJj1snc5kxo1_500.gif", 30, 150, 50, 50)
var water = makeImage("images/sky-blue-water-drop-hi.png", 250, 100, 50, 50)
var water2 = makeImage("images/sky-blue-water-drop-hi.png", 200, 150, 40, 40)
var water3 = makeImage("images/sky-blue-water-drop-hi.png", 180, 100, 20, 20)
var water4 = makeImage("images/sky-blue-water-drop-hi.png", 50, 150, 10, 10)
var water5 = makeImage("images/sky-blue-water-drop-hi.png", 110, 50, 30, 30)
var water6 = makeImage("images/sky-blue-water-drop-hi.png", 200, 150, 20, 20)
var score = 0
var scoreText = makeText(score, 10, 30, 20, "sans-serif", "#c4f3ff")
...
var help = getY(computer)
 if(help < 160) {
  ...
  var dabb = getX(water2)
  if (dabb < 0) {
    setX(water2, 300)
  }
  var dabbb = getX(water3)
  if (dabbb < 0) {
    setX(water3, 300)
  }
    
    var dabbbb = getX(water4)
  if (dabbbb < 0) {
    setX(water4, 300)
  }
    
     var dabbbbb = getX(water5)
  if (dabbbbb < 0) {
    setX(water5, 300)
  }
    
     var dabbbbbb = getX(water6)
  if (dabbbbbb < 0) {
    setX(water6, 300)
  }
    dead()
    requestAnimationFrame(dab)
    }
    
    
function dead() {
     if(collides(computer, water)) {
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
    } else if(collides(computer, water2)) {
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
    } else if(collides(computer, water3)){
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
    } else if(collides(computer, water4))  {
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
    } else if(collides(computer, water5))  {
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
    } else if(collides(computer, water6))   {
 alert("Game over!")
      alert(score)
      score = 0
      setY(computer, 150)
